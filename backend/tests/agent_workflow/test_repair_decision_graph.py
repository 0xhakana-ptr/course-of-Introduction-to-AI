from backend.app.agent_workflow.graphs.repair_decision_graph import (
    evaluate_repair_decision,
    run_repair_workflow,
)
from backend.app.agent_workflow.graphs.repair_retry_guidance import (
    build_retry_guidance,
    build_terminal_retry_guidance,
    resolve_retry_guidance_from_repair_result,
)
from backend.app.agent_workflow.graphs.repair_support import (
...
def test_repair_decision_graph_uses_llm_analysis_when_available(monkeypatch):
    monkeypatch.setattr(
        "backend.app.agent_workflow.graphs.repair_decision_graph.llm_is_configured",
        lambda: True,
    )
    monkeypatch.setattr(
        "backend.app.agent_workflow.graphs.repair_decision_graph.call_llm_sync",
...
def test_repair_workflow_graph_returns_generated_script(monkeypatch):
    monkeypatch.setattr(
        "backend.app.agent_workflow.graphs.repair_decision_graph.generate_repaired_script_with_llm",
...
def test_repair_workflow_returns_failed_result_when_graph_invoke_fails(monkeypatch):
    ...
    monkeypatch.setattr(
        "backend.app.agent_workflow.graphs.repair_decision_graph.repair_decision_graph",
        fake_graph,
    )
